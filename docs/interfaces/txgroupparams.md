...
*Defined in [src/api/procedures/setPermissionGroup.ts:35](https://github.com/PolymathNetwork/polymesh-sdk/blob/56921667/src/api/procedures/setPermissionGroup.ts#L35)*
