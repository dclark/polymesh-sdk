...
_Defined in_ [_src/api/entities/TickerReservation/index.ts:49_](https://github.com/PolymathNetwork/polymesh-sdk/blob/959efb76/src/api/entities/TickerReservation/index.ts#L49)
...
▸ **createToken**\(`args`: [CreateSecurityTokenParams](../interfaces/createsecuritytokenparams.md), `opts?`: [ProcedureOpts](../interfaces/procedureopts.md)\): _Promise‹_[_TransactionQueue_](transactionqueue.md)_‹_[_SecurityToken_](securitytoken.md)_››_

_Defined in_ [_src/api/entities/TickerReservation/index.ts:182_](https://github.com/PolymathNetwork/polymesh-sdk/blob/959efb76/src/api/entities/TickerReservation/index.ts#L182)
...
_Defined in_ [_src/api/entities/TickerReservation/index.ts:82_](https://github.com/PolymathNetwork/polymesh-sdk/blob/959efb76/src/api/entities/TickerReservation/index.ts#L82)
...
_Defined in_ [_src/api/entities/TickerReservation/index.ts:83_](https://github.com/PolymathNetwork/polymesh-sdk/blob/959efb76/src/api/entities/TickerReservation/index.ts#L83)
...
_Defined in_ [_src/api/entities/TickerReservation/index.ts:207_](https://github.com/PolymathNetwork/polymesh-sdk/blob/959efb76/src/api/entities/TickerReservation/index.ts#L207)
...
▸ **extend**\(`args`: void, `opts?`: [ProcedureOpts](../interfaces/procedureopts.md)\): _Promise‹_[_TransactionQueue_](transactionqueue.md)_‹_[_TickerReservation_](tickerreservation.md)_››_

_Defined in_ [_src/api/entities/TickerReservation/index.ts:169_](https://github.com/PolymathNetwork/polymesh-sdk/blob/959efb76/src/api/entities/TickerReservation/index.ts#L169)
...
_Defined in_ [_src/api/entities/TickerReservation/index.ts:220_](https://github.com/PolymathNetwork/polymesh-sdk/blob/959efb76/src/api/entities/TickerReservation/index.ts#L220)
...
▸ **transferOwnership**\(`args`: [TransferTickerOwnershipParams](../interfaces/transfertickerownershipparams.md), `opts?`: [ProcedureOpts](../interfaces/procedureopts.md)\): _Promise‹_[_TransactionQueue_](transactionqueue.md)_‹_[_TickerReservation_](tickerreservation.md)_››_

_Defined in_ [_src/api/entities/TickerReservation/index.ts:200_](https://github.com/PolymathNetwork/polymesh-sdk/blob/959efb76/src/api/entities/TickerReservation/index.ts#L200)
