...
*Defined in [src/api/entities/SecurityToken/TokenHolders.ts:17](https://github.com/PolymathNetwork/polymesh-sdk/blob/44d12f59/src/api/entities/SecurityToken/TokenHolders.ts#L17)*
