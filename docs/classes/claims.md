...
▸ **addClaims**(`args`: Pick‹[ModifyClaimsParams](../globals.md#modifyclaimsparams), "claims"›): *Promise‹[TransactionQueue](transactionqueue.md)‹void››*

*Defined in [src/Claims.ts:126](https://github.com/PolymathNetwork/polymesh-sdk/blob/23062de4/src/Claims.ts#L126)*
...
▸ **addInvestorUniquenessClaim**(`args`: [AddInvestorUniquenessClaimParams](../interfaces/addinvestoruniquenessclaimparams.md)): *Promise‹[TransactionQueue](transactionqueue.md)‹void››*

*Defined in [src/Claims.ts:113](https://github.com/PolymathNetwork/polymesh-sdk/blob/23062de4/src/Claims.ts#L113)*
...
▸ **editClaims**(`args`: Pick‹[ModifyClaimsParams](../globals.md#modifyclaimsparams), "claims"›): *Promise‹[TransactionQueue](transactionqueue.md)‹void››*

*Defined in [src/Claims.ts:139](https://github.com/PolymathNetwork/polymesh-sdk/blob/23062de4/src/Claims.ts#L139)*
...
*Defined in [src/Claims.ts:309](https://github.com/PolymathNetwork/polymesh-sdk/blob/23062de4/src/Claims.ts#L309)*
...
*Defined in [src/Claims.ts:259](https://github.com/PolymathNetwork/polymesh-sdk/blob/23062de4/src/Claims.ts#L259)*
...
*Defined in [src/Claims.ts:200](https://github.com/PolymathNetwork/polymesh-sdk/blob/23062de4/src/Claims.ts#L200)*
...
*Defined in [src/Claims.ts:333](https://github.com/PolymathNetwork/polymesh-sdk/blob/23062de4/src/Claims.ts#L333)*
...
*Defined in [src/Claims.ts:165](https://github.com/PolymathNetwork/polymesh-sdk/blob/23062de4/src/Claims.ts#L165)*
...
*Defined in [src/Claims.ts:360](https://github.com/PolymathNetwork/polymesh-sdk/blob/23062de4/src/Claims.ts#L360)*
...
▸ **revokeClaims**(`args`: Pick‹[ModifyClaimsParams](../globals.md#modifyclaimsparams), "claims"›): *Promise‹[TransactionQueue](transactionqueue.md)‹void››*

*Defined in [src/Claims.ts:152](https://github.com/PolymathNetwork/polymesh-sdk/blob/23062de4/src/Claims.ts#L152)*
